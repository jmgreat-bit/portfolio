                ...
                <div className="w-full flex-grow flex flex-col items-center">
                    ...
                    <div className="text-center mb-8 md:mb-12">
                        <motion.h1 
                            ...
                            className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-bold mb-4 tracking-tight"
                        >
                            Support My Work
                        </motion.h1>
                        <motion.p
                            ...
                            className="text-slate-400 text-xs sm:text-sm md:text-base lg:text-xl max-w-2xl mx-auto leading-relaxed"
                        >
                            ...
                            <AnimatePresence mode="wait">
                                            ...
                                            <div className="w-full max-w-[340px] mt-4">
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        <span className="text-white text-sm sm:text-base md:text-lg font-bold tracking-wider group-hover:text-[#FCD535] transition-colors">1041200996</span>
                                ...
                                {activeTab === "bank" && (
                                    ...
                                    >
                                        ...
                                        <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-bold mb-4 tracking-tight text-white">Bank & Mobile Money</h3>
                                        <p className="text-slate-400 text-xs sm:text-sm md:text-base lg:text-lg max-w-sm mx-auto mb-10 leading-relaxed">
